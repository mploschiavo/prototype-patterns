...
IMAGE="prototype/nodejs-ollama-mcp-server:latest"
ACTION="${1:-apply}"
case "$ACTION" in
  apply)
    ...
    echo "Use: microk8s kubectl port-forward -n integration-clients service/nodejs-ollama-mcp-server 8090:8090"
    ;;
  delete)
