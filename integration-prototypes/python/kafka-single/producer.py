"""Kafka single-node producer prototype."""
...
except ImportError:  # pragma: no cover - exercised in runtime envs with kafka-python installed
...
def main() -> None:
    topic = os.getenv("KAFKA_TOPIC", "prototype-topic")
    payload = build_message("1", "hello from python kafka single producer")
