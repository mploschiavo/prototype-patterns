...
IMAGE="prototype/python-opensearch-ha-rest:latest"
ACTION="${1:-apply}"
case "$ACTION" in
  apply)
    ...
    echo "Use: microk8s kubectl port-forward -n integration-clients service/python-opensearch-ha-rest 8080:8080"
    ;;
  delete)
