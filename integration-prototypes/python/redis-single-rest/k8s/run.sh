...
IMAGE="prototype/python-redis-single-rest:latest"
ACTION="${1:-apply}"
case "$ACTION" in
  apply)
    ...
    echo "Use: microk8s kubectl port-forward -n integration-clients service/python-redis-single-rest 8080:8080"
    ;;
  delete)
